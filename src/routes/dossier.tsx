    ...
    <NoirShell>
      <section className="px-4 max-w-5xl mx-auto">
        <header className="text-center mb-10">
          ...
          <h1 className="headline-serif text-3xl sm:text-5xl md:text-6xl mt-2">The Dossier</h1>
        </header>
        ...
        >
          ...
          <div className="mt-8 space-y-5 text-noir-ink">
            <div className="flex items-center justify-between gap-2 sm:gap-4">
              <h2 className="headline-serif text-xl sm:text-3xl">SUBJECT BRIEFING</h2>
              <span className="stamp stamp-cleared text-base sm:text-2xl">CLEARED</span>
            </div>
            <div className="ledger-rule pb-4">
              <h3 className="headline-serif text-2xl sm:text-4xl">Amna Muhammad</h3>
            </div>
